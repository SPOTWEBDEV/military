    ...
    <div class="content-wrapper">
                    ...
                    <div class="card-body py-0 px-0 px-sm-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5 col-sm-7 col-xl-8 p-0">
                                ...
                                <p class="mb-0 font-weight-normal d-none d-sm-block">You can now manage your website details from here!</p>
                            </div>
        ...
        <div class="row ">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Flights Application Requested
                            {{-- <div class="float-end">
                                    ...
                                    @forelse ($flights as $flight)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="ps-2">{{ $flight->firstname . ' ' . $flight->lastname }}</span>
                                            </td>
                                            <td>{{ $flight->email }}</td>
                                            <td>{{ $flight->number }}</td>
                                            <td>{{ $flight->gender }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('flight.delete',$flight->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Flight Booked?')">
                                                    @csrf
                                                    @method('patch')
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="py-2 float-end" style="margin-right: 20px;">{{ $flights->links('pagination::bootstrap-5') }}</div>
                    </div>
                </div>
            </div>
        </div>

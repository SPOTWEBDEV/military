...
<head>
    ...
    <title>@yield('title') | {{ config('app.name', 'UnService Military') }}</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle " src="{{ asset('pngwing.com.png') }}"
                                    alt="">
                                <span class="count bg-success"></span>
                            </div>
                            <div class="profile-name">
                                <h5 class="mb-0 font-weight-normal">Service-Un</h5>
                                <span>Admin</span>
                            </div>
                        </div>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="{{ route('admin.soldiers') }}">
                        <span class="menu-icon">
                            <i class="mdi mdi-playlist-play"></i>
                        </span>
                        <span class="menu-title">Soldier Profiles</span>
                    </a>
                </li>
                <li class="nav-item menu-items">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="{{ route('admin.flights') }}">
                        ...
                        <span class="menu-title">Flight Bookings</span>
                    </a>
                </li>
                {{-- <li class="nav-item menu-items">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <h5 style="color:red; text-align: center; display: flex; align-items: center;"> </h5>
